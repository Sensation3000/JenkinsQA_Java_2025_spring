...
public class CreateNewItemNumber1Test extends BaseTest {
    ...
    public void testItemCreation_Success() {
        ...
        WebElement createdProjectLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@class='model-link' and contains(@href, '/job/TestItemBlaBla/')]")));
